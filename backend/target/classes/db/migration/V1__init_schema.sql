...
IF DB_ID('ElectricFanShopDB') IS NOT NULL
BEGIN
    DROP DATABASE ElectricFanShopDB;
END
GO

-- Tạo lại database
CREATE DATABASE ElectricFanShopDB;
GO

-- Sử dụng database mới
USE ElectricFanShopDB;
GO
...
CREATE TABLE dbo.Carts (
    id INT PRIMARY KEY IDENTITY(1,1),
    userId INT NOT NULL,
    CONSTRAINT UQ_Carts_User UNIQUE (userId), -- 1 user chỉ có 1 cart 
...
(N'Quạt sàn Chinghai FF-802', N'Quạt sàn Chinghai FF-802 có công suất quạt 49 W quạt nhỏ, dành cho cá nhân, dùng trong gia đình, giúp không gian quanh bạn nhanh chóng được thoáng đãng, dịu mát và khiến tâm trạng của bạn cũng được thoải mái, thư giãn hơn. Thiết kế để sàn nên chuyên dùng trong gia đình, văn phòng', 460000, 'https://bizweb.dktcdn.net/100/431/060/products/quat-san-chinghai-ff-802-1.jpg?v=1659351716643', (SELECT id FROM dbo.Categories WHERE categoryName=N'Quạt sàn'), 1000),
(N'Quạt sàn chinghai FF-929', N'Quạt sàn Chinghai FF-929 có công suất quạt 105W, sải cánh 50cm, chất liệu cánh: Nhựa, cùng lưu lượng gió lớn, giúp không gian quanh bạn nhanh chóng được thông thoáng, giúp lưu thông không khí, làm mát. Thiết kế để sàn nên ngoài tên gọi là quạt sàn , nó còn có tên gọi quạt chân quỳ, Phù hợp dùng trong gia đình, văn phòng, cũng như trong môi trường sản xuất đông người.', 1000000, 'https://bizweb.dktcdn.net/100/431/060/products/quat-san-chinghai-ff929-2001928-winline-vn-7.jpg?v=1734936942130', (SELECT id FROM dbo.Categories WHERE categoryName=N'Quạt sàn'), 1000),
(N'Quạt sàn công nghiệp Komasu BS-50TN', N'Quạt sàn công nghiệp Komasu BS-50TN là sản phẩm quạt công nghiệp, lồng sắt sơn tĩnh điện, cánh hợp kim nhôm, công suất 160W gió mạnh. Loại quạt chân quỳ này thường được sử dụng trong các không gian lớn như: nhà hàng, shop, văn phòng, xưởng sản xuất, hội trường công ty, gia đình...', 2000000, 'https://bizweb.dktcdn.net/100/431/060/products/quat-san-komasu-km-500.jpg?v=1748426987333', (SELECT id FROM dbo.Categories WHERE categoryName=N'Quạt sàn'), 1000),


--Quạt hộp
(N'Quạt hộp Jiplai Thái lan JL-736', N'Quạt hộp Jiplai Thái lan JL-736  với thiết kế hợp lý, 3 tốc độ gió và 1 phím đảo gió dễ  sử dụng. Quạt được sản xuất tại Lào (nguồn gốc từ Thái Lan), là chiếc quạt nổi tiếng bền và gió khỏe.', 880000, 'https://bizweb.dktcdn.net/100/431/060/products/10363quattanjiplaithailanjl736.jpg?v=1625796499400', (SELECT id FROM dbo.Categories WHERE categoryName=N'Quạt hộp'), 1000),
(N'Quạt hộp Vinawind QH-300LP', N'Quạt hộp Vinawind QH-300LP có thiết kế dáng hộp, cho nhiều vị trí trong nhà như phòng ngủ, phòng khách, phòng cá nhân,... Cánh quạt rộng 40cm, với tốc độ vòng quay lớn, tạo sức gió mạnh mẽ, đảm bảo cung cấp gió và làm mát ổn định nhất cho mọi hoạt động của bạn.', 420000, 'https://bizweb.dktcdn.net/100/431/060/products/quat-hop-vinawind-qh-300lp.jpg?v=1742288428487', (SELECT id FROM dbo.Categories WHERE categoryName=N'Quạt hộp'), 1000),
(N'Quạt hộp Senko BD-1010', N'Quạt hộp Senko BD-1010 có thiết kế nhỏ gọn, tiện lợi, dễ di chuyển cùng nhiều màu sắc để khách hàng chọn lựa. Với 3 tốc độ khác nhau cùng 5 lá cánh quạt, quạt hộp Senko giúp người tiêu dùng dễ dàng điều chỉnh tốc độ mạnh yếu khác nhau theo nhu cầu của bản thân. Sải cánh rộng 30cm, quạt điện Senko BD-1010 cho làn gió mạnh mẽ, không khí lưu thông liên tục mang lại cảm giác mát mẻ và thoải mái khi sử dụng.', 400000, 'https://bizweb.dktcdn.net/100/431/060/products/bd88606.jpg?v=1625796628640', (SELECT id FROM dbo.Categories WHERE categoryName=N'Quạt hộp'), 1000),
(N'Quạt hộp chinghai BF-168A Sải cánh 350', N'Quạt hộp Chinghai BF-168A tạo gió ổn định, rộng khắp và rất đều nhờ các lá chắn quay nhiều hướng cùng công suất hoạt động 56W. Với các cánh quạt rộng 35cm làm tăng năng suất làm mát, chắc chắn sẽ mang đến cho cả gia đình bạn những luồng gió mát tức thì.', 700000, 'https://bizweb.dktcdn.net/100/431/060/products/quathopchinghaibf168aremote.jpg?v=1625796500363', (SELECT id FROM dbo.Categories WHERE categoryName=N'Quạt hộp'), 1000),
...
--Quạt thông gió
(N'Quạt thông gió gắn tường Tico TC-14AV6', N'Quạt thông gió gắn tường Tico TC-14AV6 có kích thước vuông, Quạt thông gió Tico được sản xuất tại Việt Nam, có giá rẻ, độ bền cao và vận hành êm ái. Lưu ý, bạn nên bớt lại 2cm để khoan bắt vít, nếu bớt lại kích thước quá nhỏ khi khoan sẽ gây vỡ tường.', 215000, 'https://bizweb.dktcdn.net/100/431/060/products/quathutgiogantuongticotc16av62-71eee5db-d1a1-4679-af8f-1a8e29889ae4.jpg?v=1625796491987', (SELECT id FROM dbo.Categories WHERE categoryName=N'Quạt thông gió'), 1000),
(N'Quạt thông gió gắn tường Senko H100', N'Quạt thông gió gắn tường Senko H100 là dòng sản phẩm quạt hút tường với sắc trắng nổi bật, đường kính cánh 10cm, thích hợp sử dụng trong không gian nhà tắm, nhà bếp,... để thanh lọc không khí.', 220000, 'https://bizweb.dktcdn.net/100/431/060/products/quathuth100jpg.jpg?v=1625796489650', (SELECT id FROM dbo.Categories WHERE categoryName=N'Quạt thông gió'), 1000),
(N'Quạt hút âm trần Senko HT150', N'Quạt hút âm trần Senko HT150 được thiết kế đẹp mắt với sắc trắng tinh tế, trang nhã. Với màng lọc được thiết kế theo công nghệ hiện đại, quạt hút âm trần Senko HT150 1 chiều có khả năng lọc khói bụi nhanh chóng, trả lại luồng không khí tươi mát, trong lành.', 300000, 'https://bizweb.dktcdn.net/100/431/060/products/ht150c.jpg?v=1625796668777', (SELECT id FROM dbo.Categories WHERE categoryName=N'Quạt thông gió'), 1000),
(N'Quạt hút âm trần Vinawind QHT-150PN', N'Quạt hút âm trần Vinawind QHT-150PN được thiết kế đẹp mắt với sắc trắng tinh tế, trang nhã. Với màng lọc được thiết kế theo công nghệ hiện đại, quạt hút âm trần Senko HT150 1 chiều có khả năng lọc khói bụi nhanh chóng, trả lại luồng không khí tươi mát, trong lành.', 310000, 'https://bizweb.dktcdn.net/100/431/060/products/hut-am-tran-vinawind-1.jpg?v=1731662581083', (SELECT id FROM dbo.Categories WHERE categoryName=N'Quạt thông gió'), 1000),
(N'Quạt hút âm trần Senko HT200', N'Quạt hút âm trần Senko HT200 được thiết kế đẹp mắt với sắc trắng tinh tế, trang nhã. Với màng lọc được thiết kế theo công nghệ hiện đại, quạt hút âm trần Senko HT200 1 chiều có khả năng lọc khói bụi nhanh chóng, trả lại luồng không khí tươi mát, trong lành. ', 320000, 'https://bizweb.dktcdn.net/100/431/060/products/ht200c.jpg?v=1625796476557', (SELECT id FROM dbo.Categories WHERE categoryName=N'Quạt thông gió'), 1000);
...
VALUES 
('admin', 'admin@123', 'admin@example.com', N'Quản trị viên', 'ADMIN');
